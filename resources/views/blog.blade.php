				...
				<div class="me-lg-4">
					<div class="row gy-5">
						<div class="col-md-6" data-aos="fade">
							<article class="blog-post">
								<div class="post-slider slider-sm rounded">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-4.jpg')}}" alt="Post Thumbnail">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-5.jpg')}}" alt="Post Thumbnail">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-3.jpg')}}" alt="Post Thumbnail">
								</div>
								<div class="pt-4">
						...
						<div class="col-md-6" data-aos="fade">
							<article class="blog-post">
								<div class="post-slider slider-sm rounded">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-1.jpg')}}" alt="Post Thumbnail">
								</div>
								<div class="pt-4">
						...
						<div class="col-md-6" data-aos="fade">
							<article class="blog-post">
								<div class="post-slider slider-sm rounded">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-2.jpg')}}" alt="Post Thumbnail">
								</div>
								<div class="pt-4">
									<p class="mb-3">14 Mar, 2020</p>
									<h2 class="h4"><a class="text-black" href="blog-details.html">Cheerful Loving Couple Bakers Drinking Coffee</a></h2>
						...
						<div class="col-md-6" data-aos="fade">
							<article class="blog-post">
								<div class="post-slider slider-sm rounded">
									<img loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-5.jpg')}}" alt="Post Thumbnail" width="420" height="280">
								</div>
								<div class="pt-4">
									<p class="mb-3">14 Mar, 2020</p>
									<h2 class="h4"><a class="text-black" href="blog-details.html">Cheerful Loving Couple Bakers Drinking Coffee</a></h2>
						...
						<li class="d-flex widget-post align-items-center">
							<a class="text-black" href="/blog/elements/">
								<div class="widget-post-image flex-shrink-0 me-3">
									<img class="rounded" loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-4.jpg')}}" alt="Post Thumbnail">
								</div>
							</a>
					...
					<ul class="list-unstyled widget-list">
						<li class="d-flex widget-post align-items-center">
							<a class="text-black" href="/blog/post-1/">
								<div class="widget-post-image flex-shrink-0 me-3">
									<img class="rounded" loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-1.jpg')}}" alt="Post Thumbnail">
								</div>
							</a>
							<div class="flex-grow-1">
					...
					<ul class="list-unstyled widget-list">
						<li class="d-flex widget-post align-items-center">
							<a class="text-black" href="/blog/post-2/">
								<div class="widget-post-image flex-shrink-0 me-3">
									<img class="rounded" loading="lazy" decoding="async" src="{{asset('assets/images/blog/post-2.jpg')}}" alt="Post Thumbnail">
								</div>
							</a>
							<div class="flex-grow-1">
								<h5 class="h6 mb-0"><a class="text-black" href="blog-details.html">Cheerful Loving Couple Bakers Drinking Coffee</a></h5>
