        ...
        <form method="POST" action="{{route('money_transaction.store')}}">
          ...
          <div class="col-lg-12 mb-4 pb-2">
            <div class="form-group">
              <label for="receive_account" class="form-label">Transfer to</label>
    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          ...
          @endif
          @else
          <a type="button" class="btn btn-primary" href="#services">Our Services <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
          @endif
          @endif
        </div>
      </div>
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async" src="{{asset('assets/images/banner/banner.png')}}" alt="banner image" class="w-100">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 service-item">
        <a class="text-black" href="{{route('smartwallet.index')}}">
          <div class="block"> <span class="colored-box text-center h3 mb-4">01</span>
            <h3 class="mb-3 service-title">Smart Wallet</h3>
            <p class="mb-0 service-description">It is a wallet and Here you having the account number with your blance and can transfer the data </p>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 service-item">
        <a class="text-black" href="{{route('smartcart.index')}}">
          <div class="block">
            <span class="colored-box text-center h3 mb-4">02</span>
            <h3 class="mb-3 service-title">Smart Cart</h3>
            <p class="mb-0 service-description">Here you can buy anything online</p>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 service-item">
        <a class="text-black" href="child">
          <div class="block"> <span class="colored-box text-center h3 mb-4">03</span>
            <h3 class="mb-3 service-title">Add Child</h3>
            <p class="mb-0 service-description">Create the child account with limitation of buying and money per day</p>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 service-item">
